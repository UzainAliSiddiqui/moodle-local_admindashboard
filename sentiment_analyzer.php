...
admindash_setup_page('/local/admindashboard/sentiment_analyzer.php', 'Sentiment Analyzer', 'courseanalytics.sentiment');
admindash_render_header('courseanalytics.sentiment');
...
<div class="admindash-sentiment-page">
    <header class="admindash-sentiment-hero" aria-labelledby="sentimentHeroTitle">
        ...
        <div class="admindash-sentiment-hero__inner">
            ...
            <h2 id="sentimentHeroTitle" class="admindash-sentiment-hero__title">Sentiment Analyzer</h2>
            <p class="admindash-sentiment-hero__lead">
                Explore qualitative tone and quantitative ratings from course feedback—designed for clarity at a glance.
            </p>
        </div>
    </header>
    ...
    <form method="get" class="admindash-filters admindash-sentiment-filter" action="<?php echo (new moodle_url('/local/admindashboard/sentiment_analyzer.php')); ?>">
        <div class="admindash-filters__header">
            ...
            <span class="admindash-filters__title">Scope</span>
        </div>
    ...
    <div id="sentimentAnalyzerRoot" class="admindash-sentiment-analyzer admindash-feedback card border-0">
        <div class="admindash-sentiment-analyzer__loading" aria-live="polite">
            <div class="admindash-sentiment-analyzer__loading-inner">
                ...
                <span class="admindash-sentiment-analyzer__loading-text">Analyzing feedback…</span>
            </div>
        </div>
        <div class="card-body p-0">
            <div class="admindash-sentiment-toolbar">
                <div class="admindash-sentiment-toolbar__titles">
                    <p class="admindash-sentiment-toolbar__eyebrow">Feedback intelligence</p>
                    <h3 class="admindash-sentiment-toolbar__title">Learner voice snapshot</h3>
                    <p class="admindash-feedback__subtitle mb-0" id="feedbackAnalyzerMeta">Select a course to load quantitative scores and AI sentiment.</p>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="admindash-sentiment-panel admindash-feedback__panel h-100">
                        <div class="admindash-sentiment-panel__head">
                            ...
                            <div>
                                <h4 class="admindash-sentiment-panel__title">Sentiment mix</h4>
                                <p class="admindash-sentiment-panel__hint">AI-estimated share of tone across open comments</p>
                            </div>
                        </div>
                        ...
                        <div id="feedbackSentimentEmpty" class="admindash-feedback__empty admindash-sentiment-empty" style="display:none">
                            ...
                            No comments available for sentiment analysis yet.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="admindash-sentiment-panel admindash-feedback__panel h-100">
                        <div class="admindash-sentiment-panel__head admindash-sentiment-panel__head--row">
                            <div class="d-flex align-items-start gap-3 flex-wrap justify-content-between w-100">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <h4 class="admindash-sentiment-panel__title">Likert averages</h4>
                                        <p class="admindash-sentiment-panel__hint">Per-question means from scaled responses</p>
                                    </div>
                                </div>
                                <span id="feedbackOverallAverage" class="admindash-sentiment-score-pill">Overall · --/5</span>
                            </div>
                        </div>
                        ...
                        <div id="feedbackQuantEmpty" class="admindash-feedback__empty admindash-sentiment-empty" style="display:none">
                            ...
                            No quantitative feedback responses yet.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="admindash-sentiment-panel admindash-feedback__panel h-100">
                        <div class="admindash-sentiment-panel__head">
                            ...
                            <div>
                                <h4 class="admindash-sentiment-panel__title">Trending themes</h4>
                                <p class="admindash-sentiment-panel__hint">Recurring phrases from learner comments</p>
                            </div>
                        </div>
                ...
                <div class="col-lg-7">
                    <div class="admindash-sentiment-panel admindash-feedback__panel h-100">
                        <div class="admindash-sentiment-panel__head">
                            ...
                            <div>
                                <h4 class="admindash-sentiment-panel__title">Highlighted comments</h4>
                                <p class="admindash-sentiment-panel__hint">Representative excerpts flagged for review. Auto-scrolls vertically; hover to pause.</p>
                            </div>
                        </div>
                        ...
                        <div id="feedbackFlaggedEmpty" class="admindash-feedback__empty admindash-sentiment-empty" style="display:none">
                            No notable comments available yet.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <nav class="admindash-sentiment-next" aria-label="Course analytics">
        <span class="admindash-sentiment-next__label">Continue exploring</span>
        <div class="admindash-sentiment-next__links">
            ...
            <span class="admindash-sentiment-next__link admindash-sentiment-next__link--current" aria-current="page">Sentiment</span>
        </div>
    </nav>
</div>
